...
# Palette used to colour instance masks per class, extended/truncated to match number_of_classes
THING_COLORS = [(0, 255, 0), (255, 0, 0), (0, 0, 255), (255, 255, 0), (255, 0, 255), (0, 255, 255)]
...
class DetectronTrainer(LearnerTrainer):
    ...
    def __init__(self, config_data):
        ...
        self.optimizer                  = config_data['training']['optimizer']
        ...
        self.thing_colors = THING_COLORS[:self.num_classes]
    ...
    def _configure(self, iterations=10000,
        ...
        cfg.SOLVER.OPTIMIZER = self.optimizer
    ...
    def _register_test_dataset(self):
        ...
        test_dataset_catalog.thing_colors = self.thing_colors
    ...
    def _register_validation_dataset(self):
        try:
            ...
            validation_dataset_catalog.thing_colors = self.thing_colors
